...
interface DatabaseContextType {
  ...
  editTransaction: (id: string, data: Partial<Omit<Transaction, 'id' | 'user_id' | 'created_at'>>) => Promise<void>;
  removeTransaction: (id: string) => Promise<void>;
  updateBudget: (category: string, limit: number | undefined, month: string) => Promise<void>;
    ...
    try {
      ...
      if (data.type === 'expense') {
        ...
        if (categoryBudget) {
          ...
          const totalSpent = categoryTxs.reduce((sum, t) => sum + Number(t.amount), 0);
